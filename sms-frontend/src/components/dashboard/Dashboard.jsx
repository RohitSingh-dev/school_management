...
const Dashboard = () => {
  ...
  return (
    <div className='dashboard'>
      <div className='dashboard-navbar'><WelcomeBar username={user.user_name}></WelcomeBar></div>
      <div className='dashboard-middle'>
        ...
        <div className='dashboard-middle-icon-wrapper'>
          <a href={user.user_role==="TEACHER"? '/TeacherAttendance' : '/Attendance/11'}>
        ...
        <div className='dashboard-middle-icon-wrapper'>
          <a href={user.user_role==="TEACHER"? '/TeacherResult' : '/Result/11'}>
